...
#define TaskDelay(ms) vTaskDelay(ms / portTICK_PERIOD_MS)
  ...
  void Avatar::draw()
  {
    ...
    DrawContext *ctx = new DrawContext(this->expression, this->breath,
                                       ...
                                       this->rotation, this->scale, this->colorDepth, this->batteryIconStatus, this->batteryLevel, this->speechFont, this->eyeType, this->eyeblowType, this->mouthType);
    face->draw(ctx);
    delete ctx;
  }
  ...
  void Avatar::setEyeType(int eyeType)
  {
    this->eyeType = eyeType;
  }
  void Avatar::setEyeBlowType(int eyeblowType)
  {
    this->eyeblowType = eyeblowType;
  }
  void Avatar::setMouthType(int mouthType)
  {
